     ...
     //                                           //
    //     Criado por: http://www.educ8s.tv      //
   //                                           //
  //       Traduzido por: Emerson Carvalho     //
 //                                           //
///////////////////////////////////////////////
...
{
  int digitToPrint = digit - '0'; // CONVERÇÃO DO CHAR PARA INT
  switch(digitToPrint)
  {
...
int getSubscribers()
{
  ...
  Serial.print("CONECTADO A REDE: "); Serial.println(host);
